...
function university_files() {
    ...
    wp_enqueue_style('font-Awesome-Icon','//maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css');
...
function university_feature(){
    register_nav_menu('TopHeaderMenuLocation','Header Menu Location');
